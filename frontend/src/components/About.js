                    ...
                    <div className='row'>
                        ...
                        <div className='col-md-6'>
                            ...
                            <ul className="nav nav-tabs" role="tablist">
                                <li><a href="#home" id="home-tab" data-toggle="tab" role="tab">About</a></li>
                                <li><a href="#profile" id="profile-tab" data-toggle="tab" role="tab">Timeline</a></li>
                                </ul>
                             </div>
